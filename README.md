...
## Ejemplo de creación de un service, para crear una extensión de twig (filtro)

1.  Creamos la extensión que hereda de Twig_Extension
```
<?php
...
class FollowingExtension extends \Twig_Extension {
    ...
    /**
    * Indicará como se llama el filtro de twig (en este caso 'following' y a que función se llamará, en este caso followingFilter)
...
2. La inyectamos en el services.yml, dentro de services:
```
    AppBundle\Twig\FollowingExtension:
        arguments:
            $doctrine: "@doctrine"
        tags:
            - {name:twig.extension}
...
3. La utilizamos en el twig, como por ejemplo :
```
